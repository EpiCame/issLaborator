...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        IReservationRepository reservationRepository = new ReservationHibernateRepository(sessionFactory);
        MasterService service = new MasterService(userRepository, showRepository, reservationRepository);
